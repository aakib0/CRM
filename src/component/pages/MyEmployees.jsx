  ...
  return (
    <div>
      <div className="px-6 pt-1 pd-6">
        ...
        {/* Table with scroll functionality */}
            ...
            <table className="w-full min-w-[900px]">
              <thead className="sticky top-0 bg-gray-100 z-10">
                <tr className="border-b border-gray-200">
                  ...
                  <th className="px-4 pl-2 py-3 text-left text-sm font-medium text-gray-700 min-w-[100px]">
                    Employee ID
                  </th>
                  <th className="px-4 pr-2 py-3 text-left text-sm font-medium text-gray-700 min-w-[200px]">
                    Name & Email
                  </th>
                  <th className="px-4 pr-3 text-left text-sm font-medium text-gray-700 min-w-[120px]">
                    Date Created
                  </th>
                  <th className="px-4 pr-2 py-3 text-left text-sm font-medium text-gray-700 min-w-[100px]">
                    Status
                  </th>
                  <th className="px-4 pr-2 py-3 text-left text-sm font-medium text-gray-700 min-w-[130px]">
                    Role
                  </th>
                  <th className=" py-3 text-left text-sm font-medium text-gray-700 min-w-[100px]">
                    Password
                  </th>
